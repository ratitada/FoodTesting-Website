...
{
    Route::get('checklogin', array('uses'=>'ProtocolController@checklogin'));
    Route::post('countatt', array('uses'=>'ProtocolController@countatt'));
    Route::post('countch', array('uses'=>'ProtocolController@countch'));
    Route::post('summary', array('uses'=>'ProtocolController@summary'));
});